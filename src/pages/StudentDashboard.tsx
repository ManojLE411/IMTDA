...
interface StudentDashboardProps {
  ...
  availableInternships: InternshipTrack[];
...
const StudentDashboard: React.FC<StudentDashboardProps> = ({ 
  ...
  const myApplications = applications.filter(app => app.email === student.email || app.studentId === student.id);
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-white rounded-2xl shadow-md p-8 mb-8 flex flex-col md:flex-row items-center gap-6 animate-fade-in">
           ...
           <div>
             ...
             <p className="text-gray-600 mt-1 flex items-center gap-2"><User size={16} /> Student Profile • {student.email}</p>
           </div>
            ...
            <div className="bg-white rounded-xl shadow-md overflow-hidden border border-gray-100">
               ...
               <div className="p-6">
                 <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    {availableTraining.slice(0, 2).map(prog => (
