          ...
          <div className="space-y-3">
            {imagePreview ? (
              <div className="space-y-3">
                <div className="relative inline-block">
                  ...
                  <button
                    ...
                    onClick={() => {
                      ...
                      // Reset file input
                      const fileInput = document.getElementById('internship-image-upload') as HTMLInputElement;
                ...
                <div>
                  <label htmlFor="internship-image-upload-replace" className="inline-flex items-center px-4 py-2 bg-blue-600 text-white text-sm font-medium rounded-lg hover:bg-blue-700 transition-colors cursor-pointer">
                    <ImageIcon size={16} className="mr-2" />
                    Replace Image
                    <input 
                      id="internship-image-upload-replace" 
                      type="file" 
                      className="sr-only" 
                      accept="image/*" 
              ...
              <div className="flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 border-dashed rounded-lg hover:bg-gray-50 transition-colors">
                <div className="space-y-2 text-center">
                  ...
                  <div className="flex text-sm text-gray-600 justify-center">
                    <label htmlFor="internship-image-upload" className="relative cursor-pointer bg-white rounded-md font-medium text-blue-600 hover:text-blue-500 focus-within:outline-none">
                      <span>Upload an image</span>
                      <input 
                        id="internship-image-upload" 
                        name="internship-image-upload" 
                        type="file" 
                        className="sr-only" 
                        accept="image/*" 
                        onChange={handleImageChange} 
